...
export function AnnouncementBar() {
  ...
  return (
    <div className="bg-slate-950 text-amber-200 text-xs py-2 px-4 border-b border-slate-800/80 flex items-center justify-between font-medium tracking-wide">
      <div className="flex-1 flex items-center justify-center gap-3 overflow-hidden text-center">
        ...
        <p className="truncate text-[11px] sm:text-xs text-amber-100">
          ✨ Gunakan Kode Voucher di Checkout | Garansi 100% Produk Leather Goods Asli Garut
        </p>
        <span className="hidden md:inline-flex items-center gap-1 text-[10px] text-amber-400 font-semibold border-l border-slate-800 pl-3">
      ...
      <button
        ...
        className="text-amber-400/70 hover:text-amber-200 p-0.5 rounded-md hover:bg-slate-900 transition-colors shrink-0 ml-2"
